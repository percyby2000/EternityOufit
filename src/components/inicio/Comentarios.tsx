  ...
  return (
    <section className="py-16">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-3xl font-light text-center text-gray-700 mb-16">Lo que dicen nuestros clientes</h2>
        
        <div className="relative">
          {/* Comillas decorativas */}
          <div className="text-gray-200 text-8xl font-serif absolute -top-10 left-0 opacity-50">"</div>
          ...
          <div className="text-center px-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-medium text-gray-900">{testimonios[currentIndex].nombre}</h3>
              <p className="text-sm text-gray-500">{testimonios[currentIndex].rol}</p>
            </div>
          </div>
